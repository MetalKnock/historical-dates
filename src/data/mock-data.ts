...
const HISTORICAL_DATES: HistoricalDates = [
  {
    ...
    facts: [
      ...
      },
      {
        id: 2,
        year: 1984,
        description: 'Авиакомпания Virgin Atlantic Airways начала коммерческие полёты',
      },
      {
        id: 3,
        year: 1985,
  ...
  },
  {
    ...
    facts: [
      ...
      },
      {
        id: 4,
        year: 1991,
        description: '«Семейка Аддамс»/The Addam Family, США (реж. Барри Зонненфельд )',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    facts: [
      ...
      },
      {
        id: 1,
        year: 2000,
        description: 'На конкурсе «Окно в Россию» «театром года» назван новосибирский «Глобус»',
      },
      {
        id: 2,
        year: 2001,
  ...
  },
  {
    ...
    facts: [
      ...
      },
      {
        id: 6,
        year: 2011,
        description: 'На церемонии BRIT Awards по две награды получили Тайни Темпа и Arcade Fire',
      },
      {
        id: 7,
        year: 2012,
        description: 'В Архангельске (Россия) прошёл первый рок-фестиваль «Остров»',
      },
      {
        id: 8,
        year: 2013,
  ...
  },
  {
    ...
    facts: [
      ...
      },
      {
        id: 4,
        year: 2019,
        description: 'Google объявил о создании кубитного квантового компьютера',
      },
      {
        id: 5,
        year: 2020,
